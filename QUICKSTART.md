# Fullstack Development Team Workflow - Quick Start Guide
...
```bash
# 기본 실행
/fullstack-development-team-workflow "작업 설명을 여기에 입력하세요"

# 예제
/fullstack-development-team-workflow "사용자 인증 기능을 구현해주세요"
```
...
```bash
# 상세 문서 확인
cat claude.config/fullstack-development-team-workflow/docs/USAGE.md
cat claude.config/fullstack-development-team-workflow/docs/ORCHESTRATOR.md
```
